...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new UserController().updateMyPosition();
        ...
        userController.getObservedUsersMail(new Listener<List<String>>() {
            ...
            public void update(final List<String> mailList) {
                if(!isNull(mailList.get(0))) {
                   userController.listenUser(mailList.get(0), new Listener<User>() {
                        @Override
                        public void update(final User user) {
                            if(mUpdatingUser == false) {
                                mUpdatingUser = true;
                                ...
                                mMapViewFragment.setUserMarker(user);
                            }
                        }
                    });
                }
